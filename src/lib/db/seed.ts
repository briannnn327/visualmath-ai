...
export function seed(): void {
  ...
  const topics = [
    ...
    },
    {
      ...
      description: "Diferensial total, aturan rantai multivariabel, dan turunan fungsi implisit.",
      icon: "chain",
      color: "#795400",
      formulaCount: 3,
      questionCount: 3,
    ...
    },
    {
      ...
      description: "Titik kritis, uji turunan kedua, ekstrem terkendala dengan pengali Lagrange.",
      icon: "auto_awesome",
      color: "#1b7f3b",
      formulaCount: 3,
      questionCount: 4,
    ...
    },
    {
      ...
      description: "Integral trippel, koordinat silinder & bola, serta aplikasi pada pusat massa.",
      icon: "orbit",
      color: "#be185d",
      formulaCount: 2,
      questionCount: 3,
  ...
  const questions: Question[] = [
    ...
    q(
      ...
      "mudah",
      "numeric",
      "Diberikan z = x² + y². Hitung nilai z di titik (2, 3).",
      "13",
      "Substitusi langsung: (2)² + (3)² = 4 + 9 = 13.",
      "z = x^2 + y^2",
    ),
    q(
      "t0",
      "mudah",
      "choice",
      "Fungsi f(x, y) = 1/(x² + y²) memiliki domain alami …",
      "Semua titik (x,y) kecuali (0,0)",
      "Penyebut x²+y² = 0 hanya ketika x = 0 dan y = 0.",
      undefined,
      [
        "Seluruh bidang R²",
        "Semua titik (x,y) kecuali (0,0)",
        "Hanya kuadran pertama",
        "Hanya lingkaran satuan",
      ],
    ),
    q(
      "t0",
      "sedang",
      "numeric",
      "Jarak antara titik A(1, −2, 3) dan B(4, 2, −1) adalah (bulatkan 4 desimal).",
      "6.4031",
      "Jarak = √((4−1)²+(2+2)²+(−1−3)²) = √(9+16+16) = √41 ≈ 6.403124237.",
      undefined,
      undefined,
      "Gunakan rumus jarak ruang.",
    ),
    q(
      "t0",
      "sulit",
      "choice",
      "Dalam koordinat polar, persamaan r = 2 sin θ merepresentasikan …",
      "Lingkaran",
      "r = 2 sin θ ⇔ r² = 2r sin θ ⇔ x²+y² = 2y ⇔ x²+(y−1)² = 1, sebuah lingkaran berpusat (0,1).",
      undefined,
      ["Garis lurus", "Lingkaran", "Parabola", "Hiperbola"],
    ),
    ...
    q(
      ...
      "mudah",
      "numeric",
      "Untuk r(t) = (t, t², t³), komponen kecepatan r'(1) pada sumbu x adalah …",
      "1",
    ...
    q(
      ...
      "mudah",
      "numeric",
      "Laju (speed) partikel r(t) = (t, t²) pada t = 1 adalah (4 desimal).",
      "2.2361",
      "v = r'(t) = (1, 2t); |v(1)| = √(1+4) = √5 ≈ 2.23607.",
      undefined,
      undefined,
      "Laju = panjang vektor kecepatan.",
    ),
    q(
      "t1",
      "sedang",
      "numeric",
      "Laju (speed) partikel r(t) = (3 cos t, 3 sin t) adalah (konstan) = (4 desimal).",
      "3",
      "r'(t) = (−3 sin t, 3 cos t); |v| = √(9 sin²t + 9 cos²t) = 3.",
      undefined,
      undefined,
      "Gunakan identitas sin²+cos²=1.",
    ),
    q(
      "t1",
      "sulit",
      "numeric",
      "Vektor percepatan r''(t) untuk r(t) = (t², et) pada t = 0 adalah (pisahkan koma, 4 desimal).",
      "2,1",
      "r''(t) = (2, et); r''(0) = (2, 1).",
      undefined,
      undefined,
      "Turunkan dua kali komponen per komponen.",
    ),
    ...
    q(
      ...
      "mudah",
      "numeric",
      "Nilai limit lim_{(x,y)→(0,0)} (x² + y²) adalah …",
      "0",
      "Fungsi polinomial (x²+y²) kontinu dan bernilai 0 di (0,0), substitusi langsung memberi 0.",
      undefined,
    ),
    q(
      "t2",
      "mudah",
      "choice",
      "Nilai limit berikut yang TIDAK ada adalah …",
      "lim_{(x,y)→(0,0)} xy/(x²+y²)",
      "Sepanjang y = mx, nilai menjadi m/(1+m²) bergantung pada m sehingga limit tak ada.",
      undefined,
      ["lim (x²+y²)", "lim sin(x²+y²)/(x²+y²)", "lim xy/(x²+y²)", "lim (x²−y²)"],
    ),
    q(
      "t2",
      "sedang",
      "numeric",
      "lim_{(x,y)→(0,0)} sin(x²+y²)/(x²+y²) = (4 desimal).",
      "1",
      "Dengan u = x²+y² → 0, kita punya sin(u)/u → 1.",
      undefined,
      undefined,
      "Substitusi u = x²+y².",
    ),
    q(
      ...
      "sulit",
      "choice",
      "Fungsi f(x,y) = xy/(x²+y²) untuk (x,y)≠(0,0) dan f(0,0)=0 bersifat …",
      "Tidak kontinu di (0,0)",
      "Karena limit tak ada di (0,0), f tidak kontinu di titik itu.",
      undefined,
      [
        "Kontinu di (0,0)",
        "Tidak kontinu di (0,0)",
        "Kontinu di seluruh R²",
        "Tidak terdefinisi di R²",
      ],
    ),
    ...
    q(
      ...
      "mudah",
      "numeric",
      "Untuk f(x, y) = 3x²y, nilai ∂f/∂x di titik (1, 2) adalah …",
      "12",
      "∂f/∂x = 6xy; di (1,2) = 6·1·2 = 12.",
      "f(x,y) = 3x^2 y",
    ),
    q(
      "t3",
      "mudah",
      "numeric",
      "Untuk f(x, y) = x² + 3xy, nilai ∂f/∂y di titik (1, 2) adalah …",
      "3",
      "∂f/∂y = 3x; di (1,2) = 3.",
      undefined,
    ),
    q(
      ...
      "sedang",
      "numeric",
      "Untuk f(x, y) = x² + 3xy + y², nilai ∂²f/∂x∂y (turunan campuran) adalah …",
      "3",
      "∂f/∂y = 3x + 2y, lalu ∂/∂x → 3. (Teorema Clairaut)",
      undefined,
      undefined,
      "Turunkan terhadap y dulu, lalu x.",
    ),
    q(
      "t3",
      "sedang",
      "numeric",
      "Vektor gradien ∇f di titik (1, 2) untuk f = x² + y² memiliki komponen x = …",
      "2",
      "∇f = (2x, 2y); di (1,2) → 2·1 = 2.",
      undefined,
    ),
    q(
      "t3",
      "sulit",
      "numeric",
      "Turunan berarah Duf untuk f = x²+y², u = (1/√2, 1/√2), di (1, 2) adalah (4 desimal).",
      "4.2426",
      "Duf = ∇f·u = (2, 4)·(1/√2, 1/√2) = 6/√2 ≈ 4.24264.",
      undefined,
      undefined,
      "Kalikan titik gradien dengan vektor satuan.",
    ),
    ...
    q(
      ...
      "mudah",
      "numeric",
      "Jika z = f(x,y), x = t² dan y = t³, maka dz/dt di t = 1 untuk f_x = 2 dan f_y = 3 adalah …",
      "13",
      "dz/dt = fx·dx/dt + fy·dy/dt = 2·(2t) + 3·(3t²) = 4·1 + 9·1 = 13.",
      undefined,
      undefined,
    ...
    q(
      ...
      "sedang",
      "numeric",
      "Diferensial total dz untuk f = x²y di (1, 2) dengan dx = 0.1, dy = 0.2 adalah (4 desimal).",
      "0.6",
      "fx = 2xy = 4, fy = x² = 1; dz = fx·dx + fy·dy = 4·0.1 + 1·0.2 = 0.6.",
      undefined,
      undefined,
      "dz = fx·dx + fy·dy.",
    ),
    q(
      ...
      "sulit",
      "numeric",
      "Untuk f(x, y, z) = x²yz, nilai ∂f/∂z di titik (1, 2, 3) adalah …",
      "2",
      "∂f/∂z = x²y = 1·2 = 2.",
      undefined,
    ),
    ...
    q(
      ...
      "mudah",
      "choice",
      "Titik kritis f(x, y) = x² + y² di (0,0) adalah …",
      "Titik minimum lokal",
      "Matriks Hessian = [[2,0],[0,2]], definit positif → minimum.",
      undefined,
      ["Titik maksimum lokal", "Titik minimum lokal", "Titik pelana", "Bukan titik kritis"],
    ),
    q(
      "t5",
      "sedang",
      "choice",
      "f(x, y) = xy memiliki titik pelana di …",
      "(0, 0)",
      "Hessian = [[0,1],[1,0]], D = −1 < 0 → pelana.",
      undefined,
      ["(1, 1)", "(0, 0)", "(−1, 1)", "Tidak ada"],
    ),
    q(
      "t5",
      "sedang",
      "numeric",
      "Nilai maksimum f(x, y) = 4 − x² − y² adalah …",
      "4",
      "Turunan parsial nol di (0,0): f = 4 − 0 − 0 = 4.",
      undefined,
    ),
    q(
      "t5",
      "sulit",
      "numeric",
      "Dengan pengali Lagrange, nilai maksimum dari x+y terkendala x² + y² = 8 adalah (4 desimal).",
      "4",
      "x = y = 2 memberi x+y = 4 (cek: 4+4=8).",
      undefined,
      undefined,
      "Gradien f sejajar gradien kendala: (1,1) = λ(2x,2y).",
    ),
    ...
    q(
      ...
      "mudah",
      "numeric",
      "Nilai ∫₀¹∫₀² (x + y) dy dx adalah …",
      "3",
      "∫ dy: [xy + y²/2]₀² = 2x + 2; lalu ∫₀¹ (2x+2) dx = 1 + 2 = 3.",
    ...
    q(
      ...
      "mudah",
      "numeric",
      "Nilai ∫₀¹∫₀¹ x² y dy dx adalah (4 desimal).",
      "0.1667",
      "∫₀¹ x² [y²/2]₀¹ dx = ∫₀¹ x²/2 dx = 1/6 ≈ 0.166667.",
      undefined,
      undefined,
      "Integralkan y dulu, lalu x.",
    ),
    q(
      "t6",
      "sedang",
      "numeric",
      "Volume di bawah z = x²+y² di atas persegi [0,1]×[0,1] adalah (4 desimal).",
      "0.6667",
      "∫₀¹∫₀¹ (x²+y²) dy dx = ∫₀¹ (x² + 1/3) dx = 1/3 + 1/3 = 2/3.",
      undefined,
    ),
    q(
      "t6",
      "sulit",
      "choice",
      "Mengubah urutan integrasi pada ∫₀¹∫₀ˣ f dy dx menghasilkan …",
      "∫₀¹∫ᵧ¹ f dx dy",
      "Daerah: 0≤y≤x≤1 ekuivalen dengan 0≤y≤1 dan y≤x≤1.",
      undefined,
      ["∫₀¹∫₀ˣ f dx dy", "∫₀¹∫ᵧ¹ f dx dy", "∫₀ˣ∫₀¹ f dy dx", "∫ᵧ¹∫₀¹ f dx dy"],
    ),
    ...
    q(
      ...
      "mudah",
      "numeric",
      "Volume kubus satuan ∫₀¹∫₀¹∫₀¹ dz dy dx adalah …",
      "1",
      "1·1·1 = 1.",
      undefined,
    ),
    q(
      ...
      "sedang",
      "numeric",
      "Volume silinder r ≤ 1, 0 ≤ z ≤ 2 dalam koordinat polar adalah (pi desimal: 3.1416).",
      "6.2832",
      "V = ∫₀²∫₀¹∫₀^{2π} r dθ dr dz = 2π·(1/2)·2 = 2π ≈ 6.2832.",
      undefined,
      undefined,
      "Elemen luas polar: r dr dθ.",
    ),
    q(
      "t7",
      "sulit",
      "numeric",
      "Massa benda dengan rapat 1 di kuartal bola x²+y²+z²≤1, z≥0 (koordinat bola) = (4 desimal).",
      "2.0944",
      "V = (1/2)·(4π/3) = 2π/3 ≈ 2.09440.",
      undefined,
      undefined,
      "Setengah volume bola satuan.",
    ),
  ];
  ...
  const materials = [
    ...
    },
    {
      ...
      content: "Gradien ∇f mengarah ke kenaikan tercepat. Duf = ∇f·u. Contoh: f = x²+y² di (1,2).",
      createdBy: "u-dosen1",
      updatedAt: ts(9),
    },
    {
